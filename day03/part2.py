...
# find the most common bit for each bit position and scale down the sample size as you go
# try sorting the data set
...
def compute(input: str):
    ...
    for line in lines:
        if bitcount == None:
            ...
            threshold = list(reversed(range(binlength)))
